...
export const ViteIcon = ({ className }: TechIconProps) => {
  return (
    <svg
    ...
    >
      ...
      <defs id="defs50">
        ...
        >
          <stop stop-color="#a3a3a3" id="stop38" />
          <stop offset="1" stop-color="#c3c3c3" id="stop40" />
        </linearGradient>
        <linearGradient
          id="paint1_linear"
          x1="194.651"
          ...
          gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)"
        >
          <stop stop-color="#ffffff" id="stop43" />
          <stop offset=".0833" stop-color="#ffffff" id="stop45" />
