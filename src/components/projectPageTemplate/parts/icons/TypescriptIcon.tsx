...
export const TypescriptIcon = ({ className, isActive }: TechIconWithActiveProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" className={className}>
      ...
      <rect x="2" y="2" width="28" height="28" rx="1.312" style={{ fill: isActive ? COLOR_PRIMARY : COLOR_WHITE }} />
      <path
        ...
        style={{ fill: "#293868", fillRule: "evenodd" }}
      />
    </svg>
  );
};
