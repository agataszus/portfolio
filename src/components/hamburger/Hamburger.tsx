...
export const Hamburger = ({ isCloseVisible, handleClick }: HamburgerProps) => {
  ...
  return (
    <motion.div
      className={cn(
        ...
        isCloseVisible && "[--bg-opacity:1]"
      )}
      onClick={handleClick}
      variants={hamburgerDraw}
      initial={["hamburgerVisible", "bar1Initial", "bar3Initial"]}
      animate={
        isCloseVisible ? ["closeVisible", "bar1Moved", "bar3Moved"] : ["hamburgerVisible", "bar1Initial", "bar3Initial"]
      }
    >
